...
const required = [
  ...
  'site/assets/images/lesson-qr.png',
  ...
  'site/assets/screenshots/08-jupyter-demo.png',
  'site/assets/screenshots/09-login.png',
  'site/assets/screenshots/entry-home-original.png',
  'site/assets/screenshots/entry-login-original.png',
  'site/assets/screenshots/entry-framework-home-original.png',
