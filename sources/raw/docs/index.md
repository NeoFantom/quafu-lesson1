Title: Quafu Superconducting Quantum Computing Cloud

URL Source: https://quafu-sqc.readthedocs.io/en/latest/

Markdown Content:
## 1. Introduction[¤](https://quafu-sqc.readthedocs.io/en/latest/#1-introduction "Permanent link")
...
> Users can fully experience the quantum computing resources freely with `QuarkStudio`(see [Installation](https://quafu-sqc.readthedocs.io/en/latest/#2-installation)).

## 2. Installation[¤](https://quafu-sqc.readthedocs.io/en/latest/#2-installation "Permanent link")
...
## 3. Quick Guide[¤](https://quafu-sqc.readthedocs.io/en/latest/#3-quick-guide "Permanent link")
...
![Image 1: count](https://quafu-sqc.readthedocs.io/en/latest/2024041917095371986.jpg)

## 4. Technical Support[¤](https://quafu-sqc.readthedocs.io/en/latest/#4-technical-support "Permanent link")

If you encounter any problems, please feel free to contact us and we will provide immediate feedback. Contact email: quafu_ts@baqis.ac.cn
